...
class FragMarket : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.techno.setOnClickListener { getNewsH("technology", "") }
        binding.buss.setOnClickListener { getNewsH("business", "") }
    ...
    // NewsAPI calls - these already use callbacks which run on main thread
    // The library handles threading internally, so no additional coroutine wrapping needed
